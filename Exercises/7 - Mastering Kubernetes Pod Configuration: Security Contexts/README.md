...
#### Instructions
##### Explain the available Pod-level security context fields:
...
##### Create the following Pod manifest file:
```
...
##### Create the Pod and use exec to list the available devices in the container:

###### Note: If you get a "container not found" error, just wait 10-20 seconds before running the command again
...
##### List the devices available in the container:
