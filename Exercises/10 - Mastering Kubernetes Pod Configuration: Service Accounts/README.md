...
###### 4. Press q to quit the previous output and then create a new ServiceAccount:
...
> The output confirms the app-sa ServiceAccount is being used. Upon pod creation, the ServiceAccount added a projected volume for authentication onto the pod to allow communication with the kube-api-server.
